 ...
 * 
 * Изменение FPS
 * Чтобы изменить FPS, просто присвойте нужное значение переменной fps (объявлена в common.h).
 * По умолчанию используется чатота обновления монитора. Если вы хотите получить
 * fps по умолчанию, то прочитайте эту переменную в функции gml_setup_after_drm.
 */
...
/** Читает и инициализирует конфиг */
